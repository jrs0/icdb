---
title: "Risk trade-off models from HES Spells (primary diagnosis)"
author: "John Scott"
date: "`r Sys.Date()`"
output:
...
#data_input <- "../risk_tradeoff_episodes/gendata/dataset_2015_2023.rds"

risk_tradeoff_minimal_dataset <- readRDS(data_input)
dataset <- risk_tradeoff_minimal_dataset %>%
    filter(date >= start, date <= end) %>%
    dplyr::select(-matches("hospital_provider_spell_identifier")) %>%
...
Plots of predictions for a selection of patients
...
Plots of risk tradeoff for each model
...
Variables removed in the models:
