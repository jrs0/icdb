---
title: "Bleeding/ischaemia risk trade-off using HES ICD data"
author: "John Scott"
date: "`r Sys.Date()`"
output:
...
Models are based on the primary diagnosis and all secondary diagnosis fields of the HES episode dataset. The dataset contains `r num_acs_patients` index ACS events, from `r start` to `r end`
...
Total input predictors:

```{r echo=FALSE}
predictors
```

Remaining predictors after preprocessing:
