...
## 100,000 codes takes about 16 seconds currently (now 4 seconds)
## 200,000 - 32 seconds (7 seconds)
## 300,000 - 47 seconds (9 seconds)
## 1,000,000 - not measured before (26 seconds)
## 6.5m - 15mins (2 minutes 24 seconds)
spells <- all_spells %>%
